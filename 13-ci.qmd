...
Of course, if you’re developing a Python package, use `nix-shell --run "pytest"`
...
[tlang](https://github.com/b-rodrigues/tlang) repository
...
[here](https://github.com/b-rodrigues/tlang/blob/main/.github/workflows/unit-tests.yaml).
