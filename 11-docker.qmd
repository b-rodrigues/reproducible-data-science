...
code with FP principles, orchestrated pipelines with `{rixpress}`, and made
them robust with error handling and debugging. Now we turn to
**distribution**: how do we share our work with others who may not have Nix
installed?
