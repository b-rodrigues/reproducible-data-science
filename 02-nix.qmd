...
the Ubuntu Linux distribution, you have likely used `apt-get` to install software. 
On macOS, you may have used `homebrew` for similar purposes. Nix functions in a comparable way but has many
...
Our goal is to learn how to fulfil all the requirements to build reproducible projects.
