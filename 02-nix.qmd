...
While Nix is powerful, there are some limitations and practical hurdles to be aware of:
...
- Disk space and builds: Because Nix never mutates software in place, the store can accumulate large amounts of data. 
  Cache misses sometimes force local builds, which can be slow and resource-intensive.
