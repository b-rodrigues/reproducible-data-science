...
But thankfully we live in the AI age, and LLMs can be quite helpful here. My goal is
for you not to have to worry (too much) about setting up projects
and making them reproducible, thanks to LLMs and T—a new programming language
made specifically for setting up reproducible pipelines.
