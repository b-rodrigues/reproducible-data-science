...
worry (too much) about project setup, letting LLMs handle the heavy lifting.
...
But first, let me show you what we're building. The snippet below is a
complete **Reproducible Analytical Pipeline** (RAP) written in T:
