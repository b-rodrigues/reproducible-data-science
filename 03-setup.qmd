...
This doesn't mean never use a notebook. It means the *deliverable* shouldn't be
one. You can explore in a notebook and then turn that exploration into a clean,
plain-text pipeline — which is exactly what we'll do with T.
