...
```{r, echo = F}
knitr::include_graphics("images/packaging.png")
```
</div>
...
*most of the time* safely ignore these, especially if the package is only intended
...
The Python packaging ecosystem is rapidly modernising. While we use Nix to
...
modern tool, for one specific purpose: initialising our project's configuration
...
Goal: to build a complete, testable, and documented Python package and make it
available in a reproducible Nix environment.
